...
//        wAdapter.notifyDataSetChanged();
    ...
    public void saveWeightsWorkout(View view){
        ...
        // get id of the new e_exercise record
//        int weights_id = dbHandler.getNewestEWeightsID();
        // list of e_weight table ids
        // size of number of weights records to be added - will be used for r_workout_exercise table
//        int [] new_weights_ids = new int[weightsWorkout.size()];
//        // list of e_exercise table ids
//        // size of number of weights records to be added - will be used for r_workout_exercise table
//        int [] new_exercise_ids = new int[weightsWorkout.size()];
//        // list of e_type table ids
//        // size of number of weights records to be added - will be used for r_workout_exercise table
//        int [] new_type_ids = new int[weightsWorkout.size()];
